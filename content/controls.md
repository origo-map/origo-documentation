...
`searchLayersMinLength` | specifies the minimum length of how many characters should be entered before search, defualt is 2.
`searchLayersLimit` | specifies how many matches should be shown. defualt is 10.
